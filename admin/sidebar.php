...
<div class="sidebar">
    <div>
        ...
        <div class="profile">
            <div class="logo">
                <img src="../images/logoo5.png" alt="Logo">
            </div>
            <div class="profile-pic">
                <img src="../images/user.png" alt="Profile Picture">
            </div>
            <h2>Admin</h2>
            <p class="profile-id"><?php echo htmlspecialchars($useremail); ?></p>
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="doctors.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'doctors.php' ? 'active' : '';?>">Doctors</a></li>
                <li><a href="patient.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'patient.php' ? 'active' : '';?>">Patients</a></li>
                <li><a href="schedule.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'schedule.php' ? 'active' : '';?>">Schedules</a></li>
