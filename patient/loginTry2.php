...
<div class="container">
    <div class="form-box" id="formbox">
        ...
        <form action="loginTry2.php" method="POST">
            ...
            <div class="btn-field">
                <button type="button" name="login" id="signInBtn">Sign In</button>
                <button type="button" name="register" id="signUpBtn" class="disable">Sign Up</button>
            </div>
